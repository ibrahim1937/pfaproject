...
class DemandeController extends Controller
{
    ...
    public function essdashboardsuive(){
        $result = array();
        $demandeslistes = Demande::orderBy('created_at', 'DESC')->take(5)->get();
        foreach ($demandeslistes as $d) {
                $etudiant = Etudiant::find($d->id_etudiant);
                $categorie1 = CategorieDemande::find($d->id_categorie);
                $user = User::find($etudiant->id_user);
    ...
    public function dashboardprof(){
        $demande1=Rectifier::all()->count();
        $demande2=Rectifier::where('id_etat',1)->count();
        $demande3=Rectifier::where('id_etat',2)->count();
        $demande4=Rectifier::where('id_etat',4)->count();
